...
export const privacyPolicySections = [
  ...
  },
  {
    ...
    body: [
      'When you sign in, we may collect your email address, username, account identifiers, and profile data you choose to provide.',
      'When you upload files, we may collect file metadata such as filename, file type, file size, storage path, and public link information.',
      'We may also process technical data such as IP address, device information, browser information, and session data needed to operate the service.',
    ],
  },
  {
    title: '3. How We Use Information',
    body: [
      'We use information to create and manage accounts, authenticate users, store and deliver uploaded files, provide public file links, and keep the service secure.',
      'We may also use data to troubleshoot issues, prevent abuse, and improve product performance.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      'We retain account and file data for as long as needed to provide the service, satisfy legal obligations, resolve disputes, or enforce agreements.',
      'If files are deleted or accounts are removed, some information may remain in backups or logs for a limited time.',
    ],
  },
  {
  ...
  },
  {
    title: '7. Security',
    body: [
      'We use reasonable technical and organizational safeguards to protect information, but no online service can guarantee perfect security.',
    ],
  },
  {
  ...
  },
  {
    title: '10. Changes',
    body: [
      'We may update this Privacy Policy as the service evolves. The updated version will replace the previous one once published.',
    ],
  },
  {
    title: '11. Contact',
