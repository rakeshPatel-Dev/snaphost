              ...
              >
                ...
                {value === true ? (
                  <span className="flex items-center justify-center">
                    <Check className={cn('h-4 w-4', isHighlight(plan.key) ? 'text-accent' : 'text-emerald-500')} />
                  </span>
                ) : value === false ? (
                  <span className="flex items-center justify-center">
                  ...
                  <span className={cn('text-xs', isHighlight(plan.key) ? 'text-accent font-medium' : 'text-muted-foreground')}>{value}</span>
                )}
              </div>
            );
          })}
