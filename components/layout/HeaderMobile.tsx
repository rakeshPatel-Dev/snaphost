  ...
  return (
    <div className="md:hidden flex items-center gap-2">
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent
          side="right"
          className="w-72 p-0 bg-background/95 backdrop-blur-xl border-border/60"
        >
          ...
          <div className="flex flex-col gap-1 p-4">
            <p className="px-3 py-1 text-xs font-semibold uppercase tracking-widest text-muted-foreground/70">
              Navigation
            </p>
            {navLinks.map((item) => (
              <Link
