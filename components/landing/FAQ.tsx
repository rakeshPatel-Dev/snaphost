          ...
          {items.map((faq, index) => {
            ...
            return (
              <Reveal key={index} delay={index * 0.04}>
                <div className="overflow-hidden rounded-4xl border border-border/60 bg-card/95 px-5 shadow-[0_30px_80px_-40px_rgba(0,0,0,0.18)] transition-all duration-200 sm:bg-card/80 sm:backdrop-blur-xl">
                  <button
                  ...
                  >
                    <div className="overflow-hidden">
                      <p className="py-5 text-sm text-muted-foreground leading-relaxed">{faq.a}</p>
                    </div>
                  </div>
                </div>
              </Reveal>
